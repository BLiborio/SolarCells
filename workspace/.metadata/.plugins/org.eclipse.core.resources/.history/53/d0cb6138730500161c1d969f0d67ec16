...
public class Canvas {
	...
	public Canvas(int xdim, int ydim, int zdim) throws IOException {
		...
		acceptorproperties[12] = 69; //percentage of 100 IP sites
		acceptorproperties[13] = 91; //percentage of 100 OOP sites
		...
		donorproperties[2] = 2.22E9; //hole carrier mobility for IP (nm^2/(V*s))
		donorproperties[3] = q;
		donorproperties[4] = k;
		donorproperties[5] = T;
		donorproperties[6] = a;
		...
		donorproperties[11] = 2.22E9; //hole carrier mobility for OOP (nm^2/(V*s))
		donorproperties[12] = 69; //percentage of 100 IP sites
		donorproperties[13] = 91; //percentage of 100 OOP sites
		try {
	...
	private void initVar(int xdim, int ydim, int zdim) throws IOException {
		...
		if (morphology == 0) {
			...
			acceptor = importMorphology("Config1_60.csv");
		}
		printstuff("canvas.csv");
		for (int x = 0; x < dimx; x++) {
			for (int y = 0; y < dimy; y++) {
